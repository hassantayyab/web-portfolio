              ...
              >
                <div className="h-full flex flex-col p-6 rounded-2xl border border-white/10 bg-white/[0.02] backdrop-blur-sm hover:border-white/20 hover:bg-white/[0.05] transition-all duration-300">
                  ...
                  <div className="relative z-10 flex flex-col flex-1">
                    {/* Category Badge */}
                    <div className="mb-3">
                      <span className="inline-block text-xs px-3 py-1 rounded-full bg-primary/10 text-primary border border-primary/20 font-medium">
                        {blog.category}
                      </span>
                    </div>
                    ...
                    <div className="flex flex-wrap gap-1.5 mb-4">
                      {blog.tags.map((tag) => (
                        <span
                          key={tag}
                          className="text-xs px-2 py-1 rounded-md bg-white/5 text-muted-foreground/70 border border-white/5"
                        >
                          {tag}
                        </span>
                      ))}
