          ...
          {blogs.map((blog, index) => (
            ...
            >
              <Link href={`/blogs/${blog.id}`} className='block h-full cursor-pointer'>
                <div className='h-full flex flex-col p-6 rounded-2xl border border-white/10 bg-white/[0.02] backdrop-blur-sm hover:border-white/20 hover:bg-white/[0.05] transition-all duration-300 relative'>
                  {/* Hover glow effect */}
