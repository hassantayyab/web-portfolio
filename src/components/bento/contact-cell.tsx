  ...
  return (
    <Link href='/contact'>
      ...
      >
        ...
        <div className='absolute inset-0 bg-linear-to-br from-primary/30 via-primary/20 to-primary/10 opacity-70 group-hover:opacity-90 transition-opacity duration-500' />
        ...
        {/* Arrow at top right */}
        <motion.div className='absolute top-4 right-4 md:top-5 md:right-5 z-20'>
        ...
        <div className='absolute top-0 right-0 w-24 h-24 bg-primary/20 rounded-bl-full opacity-60 group-hover:opacity-80 transition-opacity blur-sm' />
      </div>
    </Link>
  );
}
